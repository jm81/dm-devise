...
Gem::Specification.new do |s|
  ...
  s.add_dependency('dm-core',       '>= 1.0.2', '< 2.0')
  s.add_dependency('dm-migrations', '>= 1.0.2', '< 2.0')
  s.add_dependency('dm-serializer', '>= 1.0.2', '< 2.0')
  s.add_dependency('dm-timestamps', '>= 1.0.2', '< 2.0')
  s.add_dependency('dm-rails',      '>= 1.0.2', '< 2.0')
