...
Last tested against devise master: 2011-03-12, commit 15d195d2f064508e074cdd3c3733c94fbdd281c4
Last tested against devise release 1.2.rc2

== Installation

Add dm-devise and dm gems to your Gemfile. The following gems are required:

  gem 'dm-core',           '~> 1.1.0.rc3'
  gem 'dm-sqlite-adapter', '~> 1.1.0.rc3' # or your preferred adapter
  gem 'dm-serializer',     '~> 1.1.0.rc3'
  gem 'dm-timestamps',     '~> 1.1.0.rc3'
  gem 'dm-rails',          '~> 1.1.0.rc3'
  gem 'dm-validations',    '~> 1.1.0.rc3' # Do not include if using data_mapper_active_model
  gem 'dm-devise',         '~> 1.2.0.rc'
